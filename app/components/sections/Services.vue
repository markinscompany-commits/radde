...
const services: Service[] = [
  ...
  },
  {
    ...
    title: 'Отопление',
    description: 'В номерах всегда тепло и комфортно — даже прохладными горными вечерами на высоте 1600 метров.',
    fullDescription: 'Автономная система отопления работает по необходимости. На высоте 1600 метров ночные температуры могут опускаться до +5°C даже летом — в номерах всегда комфортные 22-24°C.',
    sections: [],
    included: true, price: '', duration: '', format: '',
  },
  {
  ...
  },
  {
    ...
    description: 'На высоте 1600 метров, вдали от города — чистейший воздух реликтового леса и абсолютная тишина.',
    fullDescription: 'Пансионат Радде находится на высоте 1600 метров в окружении реликтового леса. Здесь нет промышленных объектов, шумных дорог и городской пыли. Сама природа — ваш оздоровительный курс.',
    sections: [
