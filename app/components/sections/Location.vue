...
const allRoutes: RouteCard[] = [
  {
    ...
    time: '3–3.5 часа', title: 'Из аэропорта Махачкалы',
  ...
  },
  {
    ...
    time: '~3 часа', title: 'На своём автомобиле',
  ...
  },
  {
    ...
    time: '~3 часа', title: 'Маршрутка из Махачкалы',
  ...
  },
  {
    ...
    time: '3–3.5 часа', title: 'Такси и трансфер',
...
const tips = [
  ...
  {
    icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 11h1a2 2 0 010 4h-1"/><path d="M3 15h11v-2a3 3 0 00-3-3H6a3 3 0 00-3 3v2"/><path d="M3 15l1 5h12l1-5"/><path d="M7.5 10.5l.5-2.5h4l.5 2.5"/></svg>`,
    title: 'Заправка',
    text: 'Последняя — в Буйнакске. В Гунибе заправки нет.',
  },
]
