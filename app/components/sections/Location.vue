...
const allRoutes: RouteCard[] = [
  ...
  },
  {
    ...
    summary: 'По трассе Р217 через Буйнакск. В Гунибе есть заправки — заполните бак заранее, чтобы поспокойнее ехать по серпантину.',
    time: '', title: 'На своём автомобиле',
    detailsHtml: `<h4>Пошаговый маршрут</h4><ol><li><strong>Махачкала → Буйнакск</strong> (трасса Р217)<br>По пути работают АЗС крупных сетей (Лукойл, Роснефть). Желательно заправиться полным баком — в горах заправки реже.</li><li><strong>Буйнакск → Унцукуль</strong> (трасса Р167)<br>По пути: самый длинный автотоннель России (~4 км), Ирганайское водохранилище, Гунибская ГЭС.</li><li><strong>Поворот у с. Унцукуль → Гуниб</strong><br>Последние 10 км — горный серпантин. Скорость 20–30 км/ч. Дорога асфальтированная, проходима на легковом авто.</li><li><strong>Гуниб → Верхний Гуниб → Пансионат Радде</strong>. В Гунибе есть АЗС, можно дозаправиться перед обратной дорогой.</li></ol><h4>Навигация</h4><ul><li>Яндекс Навигатор и Google Maps корректно ведут</li><li>Координаты: 42.394855, 46.936568</li><li>Искать: «Пансионат Радде» или «Верхний Гуниб»</li></ul><div class="route-warning">На серпантине встречаются животные — коровы, овцы, лошади. Тормозите плавно. Зимой нужны цепи или полный привод.</div>`,
  },
  {
