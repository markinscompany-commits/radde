...
export interface ExtraDef {
  ...
  title: string
  description: string
  fullDescription?: string  // развёрнутое описание для popup на /booking
...
export function useBookingExtras(): ExtraDef[] {
  return [
    ...
    // === АКТИВНЫЙ ОТДЫХ ===
    {
      ...
      fullDescription: 'Откройте Дагестан с опытным гидом. На выбор маршруты разной сложности: Гунибская крепость (2 часа), водопад Тобот (4 часа), аул-призрак Гамсутль (5–6 часов), Сулакский каньон (целый день). Группы от 2 человек. Транспорт, гид, вода включены. Бронировать минимум за день.',
      price: '2 000 ₽',
      priceValue: 2000,
      unit: 'session',
      unitLabel: 'за услугу',
    ...
    },
    {
      ...
      fullDescription: 'Прогулка верхом по реликтовому лесу на спокойных, обученных лошадях. Инструктор сопровождает группу на всём маршруте. Незабываемые виды на горы прямо из седла. Подходит новичкам, дети — от 7 лет в сопровождении взрослых, максимальный вес всадника — 100 кг. Шлемы предоставляем.',
      price: '1 500 ₽',
      priceValue: 1500,
      unit: 'guest',
    ...
    },
    {
      ...
      fullDescription: 'Рыбалка на горной реке в окрестностях пансионата. Чистейшая вода, тишина и горная форель. Сезон: май — сентябрь. Снаряжение (удочки, наживка, стульчик) включено в стоимость — приезжайте с пустыми руками.',
      price: '800 ₽',
      priceValue: 800,
      unit: 'session',
      unitLabel: 'за услугу',
    ...
    // === ОЗДОРОВЛЕНИЕ ===
    {
      ...
      fullDescription: 'Настоящая русская баня на берёзовых дровах — с паром, вениками и ледяным обливанием. Рядом — финская сауна для тех, кто предпочитает сухой жар. После парной — травяной чай на террасе с видом на вековые сосны. Ежедневно с 16:00 до 22:00, сеанс 2 часа, до 6 человек. Бронировать минимум за 3 часа.',
      price: '2 000 ₽',
      priceValue: 2000,
      unit: 'session',
      unitLabel: 'за сеанс',
    ...
    // === СЕРВИС ===
    {
      ...
      fullDescription: 'Не нужно думать о логистике — мы организуем трансфер из аэропорта Махачкалы или железнодорожного вокзала. Комфортный автомобиль, водитель, который знает каждый поворот горного серпантина. Время в пути — 3–4 часа. Бронировать минимум за сутки. Встреча с табличкой. Детское кресло — по запросу.',
      price: '5 000 ₽',
      priceValue: 5000,
      unit: 'session',
    ...
    },
    {
      ...
      fullDescription: 'Три оборудованные зоны для барбекю на территории пансионата — каждая с видом на горы. Мангал, шампуры, решётки, стол и скамейки, освещение, дрова и уголь. Мясо можно привезти своё или заказать у нас (баранина, говядина, курица — минимум за 3 часа). Время — с 11:00 до 22:00.',
      price: '1 000 ₽',
      priceValue: 1000,
      unit: 'session',
      unitLabel: 'за услугу',
    ...
    },
    {
      ...
      fullDescription: 'Вечером, когда темнеет и горы становятся силуэтами на фоне звёздного неба, мы разводим костёр на специальной площадке. Чай из горных трав, тёплые пледы, треск дров и абсолютная тишина. Ежедневно с наступлением темноты (20:00–21:00), по погоде. Костёр, дрова, чай и пледы — включены.',
      price: '500 ₽',
      priceValue: 500,
      unit: 'session',
      unitLabel: 'за услугу',
